    ...
    <div className="relative group">
      ...
      >
        {!nodeData.imageUrl ? (
          ...
          >
            <svg className="w-12 h-12 opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
